...
if text == 'مطور السورس' or text == 'مطور اسبوت' then
TextReply = '[--> aLi <--](t.me/D6D6I)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'مبرمج اسبوت' or text == 'مبرمج السورس' then
TextReply = '[--> بيقو <--](t.me/sxsx_5)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'منو المطور' or text == 'منو مطور' then
TextReply = '[--> aLi <--](t.me/D6D6I) حبيبي هذا مطور السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلو' then
